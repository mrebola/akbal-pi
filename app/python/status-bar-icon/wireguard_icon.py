...
from icon_constants import STATUS_ICON_HEIGHT, WIREGUARD_ICON_CENTER_SCALE


class WireguardStatusIcon:
    _scaled_icon_cache = {}
    _source_icon = None

    def __init__(self, status_font_size, icon_center_scale=WIREGUARD_ICON_CENTER_SCALE):
    ...
    def _get_source_icon(cls):
        ...
        icon_path = os.path.join(os.path.dirname(__file__), "..", "img", "vpn.png")
